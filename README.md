...
GearreCraft - full-stack вебзастосунок інтернет-магазину техніки та аксесуарів. Проєкт має клієнтську частину на React/Vite і серверну частину на Express з PostgreSQL.
...
```env
DATABASE_URL=postgres://user:password@localhost:5432/gearrecraft
...
MAIL_FROM=GearreCraft <noreply@gearrecraft.test>
```
